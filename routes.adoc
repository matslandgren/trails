...
In order to calculate a route between two waypoints, I would need some formulas and express them in the Cypher language. I did find link:http://gist.neo4j.org/?8635758[this example] on your website which performs similar actions. However, I didn't manage to learn enough Cypher to perform something similar for my database. The example below just illustrates what I am hoping to achieve.
